...
const config: Config = {
  ...
  tagline: 'Master the Google Cloud Platform Architect Exam',
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Google Cloud Community',
              href: 'https://www.googlecloudcommunity.com/',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} GCP PCA Course. Built with Docusaurus.`,
    },
    prism: {
